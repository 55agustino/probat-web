          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className={`${spaceGrotesk.className} text-white/60 text-sm`}>+598 94049511</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="mt-0.5 shrink-0 text-blue-400" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <span className={`${spaceGrotesk.className} text-white/60 text-sm`}>probaturuguay@gmail.com</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="mt-0.5 shrink-0 text-blue-400" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
